                ...
                <div class="w-full md:w-1/2">
                    ...
                    <div class="bg-gray-100 p-4 rounded-lg mb-6">
                        ...
                        <div class="flex items-center mt-2">
                            ...
                            <span class="text-gray-700">Expected delivery by <span
                                    class="font-medium"><?php date_default_timezone_set('asia/kolkata');
                                    echo date('l, F d', strtotime('+5 days'))?></span></span>
                        </div>
                    </div>

                    <!-- Action Buttons -->
                    <div class="flex flex-col sm:flex-row gap-3 mb-8">
                            <a href="../../add_to_cart.php?id=SM-BTHP2024" class="w-full"><button
                                class="w-full bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition flex-1 flex items-center justify-center"
                            ...
                            <a href="../../checkout.php?id=SM-BTHP2024" class="w-full"><button
                            name="buyNow" value="SM-BTHP2024"
                                class="bg-yellow-500 w-full hover:bg-yellow-600 text-white px-8 py-3 rounded-lg font-semibold transition flex-1">
                                Buy Now
                            </button></a>
                    </div>
