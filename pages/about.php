    ...
    <div id="blog" class="bg-indigo-900 text-white py-16">
        <div class="mx-auto max-w-[1330px]o px-4 sm:px-6 lg:px-8 text-center">
    ...
    <!-- Stats Section -->
    <div class="bg-indigo-800 h-40 text-white py-8">
